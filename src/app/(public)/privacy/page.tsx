	...
	return (
		<main className="min-h-screen bg-background">
			...
			<div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
				<h1 className="text-3xl font-bold text-foreground px-1 mb-6">Privacy Policy</h1>
				{/* Last Updated */}
				...
				<div className="mb-12">
					<p className="text-lg text-foreground leading-relaxed mb-4">
						Thank you for joining Financially Fit World. We at Financially Fit World ("Financially Fit World," "we,"
						"us") respect your privacy and want you to understand how we collect, use, and share data about you.
					</p>
				...
				{/* Accordion Sections */}
				<Accordion type="single" collapsible defaultValue="data-collection" className="w-full space-y-4">
					{privacyData.map((section) => (
						<AccordionItem key={section.id} value={section.id} className="px-4">
							<AccordionTrigger className="hover:no-underline py-4">
								<span className="text-base text-left font-semibold text-foreground">{section.title}</span>
							</AccordionTrigger>
