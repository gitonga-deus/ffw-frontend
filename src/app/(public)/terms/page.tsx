				...
				result.push(
					<ul key={`list-${index}`} className="list-disc list-inside mb-4 space-y-2">
						{listItems.map((item, itemIndex) => {
							...
							const beforeColon = colonIndex > -1 ? item.substring(0, colonIndex) : item
			...
			<div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
				...
				<div className="mb-12">
					<p className="text-lg text-foreground leading-relaxed mb-4">
						These Terms of Use ("Terms") were last updated on October 24, 2025. Financially Fit World's mission is to
						improve lives through learning. We create and share educational content and enable anyone anywhere to access
						that educational content to learn (students). We consider our marketplace model the best way to offer
						valuable educational content to our users. We need rules to keep our platform and services safe for you, us,
						and our student and instructor community. These Terms apply to all your activities on the Financially Fit
						World's website, the Financially Fit World mobile applications, our TV applications, our APIs, and other
						related services ("Services").
					</p>
					<p className="text-muted-foreground leading-relaxed">
						We also provide details regarding our processing of personal data of our students in our Privacy Policy. If
						you are using Financially Fit World LMS as part of your employer's Financially Fit World Business learning
						and development program, you can consult our Financially Fit World's Business Privacy Statement. If you live
						in the United States or Canada, by agreeing to these Terms, you agree to resolve disputes with Financially
						Fit World through binding arbitration (with very limited exceptions, not in court), and you waive certain
						rights to participate in class actions, as detailed in the Dispute Resolution section.
					</p>
				</div>

				{/* Accordion Sections */}
				<Accordion type="single" collapsible defaultValue="accounts" className="w-full space-y-4">
					{termsData.map((section) => (
						<AccordionItem key={section.id} value={section.id} className="px-4">
							<AccordionTrigger className="hover:no-underline py-4">
								<span className="text-left text-base font-semibold text-foreground">{section.title}</span>
							</AccordionTrigger>
