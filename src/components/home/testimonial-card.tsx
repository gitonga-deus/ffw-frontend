...
export default function TestimonialCard({ quote, author, rating }: TestimonialCardProps) {
    ...
    const colors = ["bg-emerald-500", "bg-teal-500", "bg-cyan-500", "bg-green-500", "bg-sky-500"]
    const colorIndex = author.length % colors.length
    const avatarColor = colors[colorIndex]

    return (
        <div className="h-full bg-gray-100 px-12 py-8 rounded-lg">
            {/* Quote SVG */}
            <svg
            ...
            {/* Testimonial Text */}
            <p className="leading-relaxed mb-6 text-gray-600">{quote}</p>
